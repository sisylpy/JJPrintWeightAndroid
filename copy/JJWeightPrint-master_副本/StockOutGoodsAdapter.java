    ...
    public void onBindViewHolder(InnerHolder holder, int position) {
        ...
        if (goods.getNxDistributerGoodsEntity() != null) {
            ...
            Log.d("StockOutGoodsAdapter", "商品: " + goods.getNxDistributerGoodsEntity().getNxDgGoodsName()
                + ", 订单数量: " + orderCount);
            Log.d("StockOutGoodsAdapter", "DistributerGoodsEntity: " + new Gson().toJson(goods.getNxDistributerGoodsEntity()));
            Log.d("StockOutGoodsAdapter", "nxDepartmentOrdersEntities: " + new Gson().toJson(orders));
